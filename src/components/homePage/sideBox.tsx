...
const SideBox: React.FC<sideBoxProps> = ({ children }) => {
  return (
    <div className="flex flex-col justify-end items-start gap-9 p-0">
      <h1 className="text-black font-vt323 xl:text-[40px] 2xl:text-[45px] font-normal leading-[110%] tracking-[0%] flex-none self-stretch flex-grow-0 mx-0">
        HOW TO PLAY
      </h1>
      <p className="text-black font-vt323 xl:text-[20px] 2xl:text-[22px] font-normal leading-[150%] tracking-[0%] flex-none self-stretch flex-grow-0 my-9 mx-0">
      ...
      <PrimaryButton field="PLAY" className="flex-none flex-grow-0"> </PrimaryButton>
    </div>
